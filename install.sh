...
INSTALLER_RAW_URL="https://raw.githubusercontent.com/xgauravyaduvanshii/shrinking-server/main/install.sh"
...
install_mcp() {
  ...
  sh_c cp -R "$MCP_EXTRACT_DIR/code-server-mcp" "$MCP_INSTALL_DIR"
